...
/**
 * print_magic - Printing the magic num of an ELF header.
 * @e_ident: pointing to an array containing the ELF magic num.
 * Description: Magic num wil be separated by spaces.
 */
...
/**
 * print_class - Printing the class of the ELF header.
 ...
 * @e_ident: pointing to an array containing the ELF ABI version.
 */
...
/**
 * main - to show the information contained in the ELF header at the start of an ELF file.
 * @argc: num of arguments supplied to the program.
 * @argv: arrays pointing to the arguments.
 * Return: 0 on success.
